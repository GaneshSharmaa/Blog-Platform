"""create users posts and password reset token tables

Revision ID: f3c6d4e1a9b2
Revises: a0bfd01254b3
...
revision: str = 'f3c6d4e1a9b2'
down_revision: Union[str, Sequence[str], None] = 'a0bfd01254b3'
